...
file key and its default is in [Settings](settings.md).
...
- [Settings](settings.md): every setting, generated from
  the model.
- [Using the command line](guide-cli.md): the database and token verbs.
