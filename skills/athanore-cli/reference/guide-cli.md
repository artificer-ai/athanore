...
[Command line](cli.md), generated from the command tree
itself.
...
- [Deployment](guide-deployment.md): `athanore.toml`, tokens, migrations and
  backups.
- [Command line](cli.md): every command, generated.
