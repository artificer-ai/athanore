...
Both are the same thing the command line does; see
[The command line](cli.md) for the `athanore serve` form, which also
reads pools from a configuration file and finds installed workflows.
