 ...
 *
 * There is no Storybook: this is where the theme is checked by eye
 * against the design mock before any screen is built on it. It renders
 *
 *   - every custom property `web/src/styles/theme.css` declares, read
 *     from `../styles/tokens.gen.ts` — the list `pnpm gen:theme` writes
 *     beside the stylesheet — so a token added to the token sheet shows
 *     up here without an edit; and
    ...
    <main className="text-body min-h-dvh bg-background p-6 text-foreground">
      <header className="mb-8 flex flex-wrap items-baseline gap-3">
        ...
        <span className="text-meta text-muted-foreground">
          {PATH} — every token and utility in src/styles/theme.css, generated by
          `pnpm gen:theme`
        </span>
      </header>
