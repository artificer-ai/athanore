 ...
 */
export const runActionApiPluginsWfActionsNamePost = <ThrowOnError extends boolean = false>(options: Options<RunActionApiPluginsWfActionsNamePostData, ThrowOnError>): RequestResult<RunActionApiPluginsWfActionsNamePostResponses, RunActionApiPluginsWfActionsNamePostErrors, ThrowOnError> => (options.client ?? client).post<RunActionApiPluginsWfActionsNamePostResponses, RunActionApiPluginsWfActionsNamePostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
